...
source_openwrt_Setting() {
		...
		echo "src-git kenzo https://github.com/kenzok8/openwrt-packages"  >> feeds.conf.default && update_feeds
        echo "src-git small https://github.com/kenzok8/small"  >> feeds.conf.default && update_feeds
